...
spawnCustomObjects()
{
	// TODO: USE A LOOP INSTEAD OF SPAWNING OBJECTS ONE BY ONE ------------------------------------------------------

	// Back/Mystery Box Walls // 22 Difference
    spawnObject( "p6_zm_bank_pilaster_1", (2351, -610, -55 ), ( 0, 180, 0 ) ); // Middle
	spawnObject( "p6_zm_bank_pilaster_1", (2373, -610, -55 ), ( 0, 180, 0 ) ); // Right
	spawnObject( "p6_zm_bank_pilaster_1", (2395, -610, -55 ), ( 0, 180, 0 ) );
	spawnObject( "p6_zm_bank_pilaster_1", (2417, -610, -55 ), ( 0, 180, 0 ) );
    spawnObject( "p6_zm_bank_pilaster_1", (2329, -610, -55 ), ( 0, 180, 0 ) ); // Left
	spawnObject( "p6_zm_bank_pilaster_1", (2307, -610, -55 ), ( 0, 180, 0 ) );
	spawnObject( "p6_zm_bank_pilaster_1", (2285, -610, -55 ), ( 0, 180, 0 ) );

	// Front Walls
	spawnObject( "p6_zm_bank_pilaster_1", (2351, -896, -55 ), ( 0, 0, 0 ) ); // Middle
	spawnObject( "p6_zm_bank_pilaster_1", (2373, -896, -55 ), ( 0, 0, 0 ) ); // Right
	spawnObject( "p6_zm_bank_pilaster_1", (2395, -896, -55 ), ( 0, 0, 0 ) );
	spawnObject( "p6_zm_bank_pilaster_1", (2417, -896, -55 ), ( 0, 0, 0 ) );
	spawnObject( "p6_zm_bank_pilaster_1", (2439, -896, -55 ), ( 0, 0, 0 ) );
    spawnObject( "p6_zm_bank_pilaster_1", (2329, -896, -55 ), ( 0, 0, 0 ) ); // Left
	spawnObject( "p6_zm_bank_pilaster_1", (2307, -896, -55 ), ( 0, 0, 0 ) );
	spawnObject( "p6_zm_bank_pilaster_1", (2285, -896, -55 ), ( 0, 0, 0 ) );
	spawnObject( "p6_zm_bank_pilaster_1", (2263, -896, -55 ), ( 0, 0, 0 ) );
	spawnObject( "collision_wall_512x512x10_standard", (2351, -896, 0 ), ( 0, 0, 0 ) ); // Invisible Collider

	// Right Walls
	spawnObject( "p6_zm_bank_pilaster_1", (2263, -588, -55 ), ( 0, -90, 0 ) );
	spawnObject( "p6_zm_bank_pilaster_1", (2263, -610, -55 ), ( 0, -90, 0 ) );
	spawnObject( "p6_zm_bank_pilaster_1", (2263, -632, -55 ), ( 0, -90, 0 ) );
	spawnObject( "p6_zm_bank_pilaster_1", (2263, -654, -55 ), ( 0, -90, 0 ) );
	spawnObject( "p6_zm_bank_pilaster_1", (2263, -676, -55 ), ( 0, -90, 0 ) );
	spawnObject( "p6_zm_bank_pilaster_1", (2263, -698, -55 ), ( 0, -90, 0 ) );
	spawnObject( "p6_zm_bank_pilaster_1", (2263, -720, -55 ), ( 0, -90, 0 ) );
	spawnObject( "p6_zm_bank_pilaster_1", (2263, -742, -55 ), ( 0, -90, 0 ) );
	spawnObject( "p6_zm_bank_pilaster_1", (2263, -764, -55 ), ( 0, -90, 0 ) );
	spawnObject( "p6_zm_bank_pilaster_1", (2263, -786, -55 ), ( 0, -90, 0 ) );
	spawnObject( "p6_zm_bank_pilaster_1", (2263, -808, -55 ), ( 0, -90, 0 ) );
	spawnObject( "p6_zm_bank_pilaster_1", (2263, -830, -55 ), ( 0, -90, 0 ) );
	spawnObject( "p6_zm_bank_pilaster_1", (2263, -852, -55 ), ( 0, -90, 0 ) );
	spawnObject( "p6_zm_bank_pilaster_1", (2263, -874, -55 ), ( 0, -90, 0 ) );
	spawnObject( "p6_zm_bank_pilaster_1", (2263, -896, -55 ), ( 0, -90, 0 ) );

	// Left Walls
	spawnObject( "p6_zm_bank_pilaster_1", (2439, -588, -55 ), ( 0, 90, 0 ) );
	spawnObject( "p6_zm_bank_pilaster_1", (2439, -610, -55 ), ( 0, 90, 0 ) );
	spawnObject( "p6_zm_bank_pilaster_1", (2439, -632, -55 ), ( 0, 90, 0 ) );
	spawnObject( "p6_zm_bank_pilaster_1", (2439, -654, -55 ), ( 0, 90, 0 ) );
	spawnObject( "p6_zm_bank_pilaster_1", (2439, -676, -55 ), ( 0, 90, 0 ) );
	spawnObject( "p6_zm_bank_pilaster_1", (2439, -698, -55 ), ( 0, 90, 0 ) );
	spawnObject( "p6_zm_bank_pilaster_1", (2439, -720, -55 ), ( 0, 90, 0 ) );
	spawnObject( "p6_zm_bank_pilaster_1", (2439, -742, -55 ), ( 0, 90, 0 ) );
	spawnObject( "p6_zm_bank_pilaster_1", (2439, -764, -55 ), ( 0, 90, 0 ) );
	spawnObject( "p6_zm_bank_pilaster_1", (2439, -786, -55 ), ( 0, 90, 0 ) );
	spawnObject( "p6_zm_bank_pilaster_1", (2439, -808, -55 ), ( 0, 90, 0 ) );
	spawnObject( "p6_zm_bank_pilaster_1", (2439, -830, -55 ), ( 0, 90, 0 ) );
	spawnObject( "p6_zm_bank_pilaster_1", (2439, -852, -55 ), ( 0, 90, 0 ) );
	spawnObject( "p6_zm_bank_pilaster_1", (2439, -874, -55 ), ( 0, 90, 0 ) );
	spawnObject( "p6_zm_bank_pilaster_1", (2439, -896, -55 ), ( 0, 90, 0 ) );
